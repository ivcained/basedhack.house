...
[https://base.party.app/party/0x44a19122E4E7661c0e9e82d5E23896E6c0568d4c](Base Party)

Let's embark on this journey together and make DevCon 7 an unparalleled celebration of innovation and community. We look forward to welcoming [https://www.base.org/](Base) as a key sponsor of the Based Hack House @ DevCon 7.

## Build with other Based Builders @ The Based Hack House, Bangkok, Thailand @ DevCon 7 SEA.

```
A Project by the Base Builders Community for Builders everywhere.
```
...
**Imagine this:** <p>A stunning Thai villa pulsates with the energy of a select group of hackers, all
...
**[https://devcon.org/en/](DevCon 7 Venue)** : 60 Ratchadaphisek Rd, Khlong Toei, Bangkok 10110, Thailand
...
* **Exclusive Perks Galore:** <p>Get ready for a special airdrop of NFTs and Tokens on Base, just
...
We are focused on finding a hack house in an area that is close (10-15 Minutes) to the main venue (
...
<p>Currently we have found the following houses which can comfortably accommodate 15-
hackers.</p>
...
## This is a Base Community led effort aimed to bring more builders on chain.

# Applicants:

Our Judges will choose the accepted hackers.
We invite jesse@base.org to be our first Judge of the Based Hack House.
...
<p>This Code of Conduct lays the foundation for a successful and rewarding Based Hack House Thailand experience. Together, we can create a safe, collaborative, and innovative environment where all participants can thrive.

Thank you for your commitment to making the Based Hack House Thailand a truly unforgettable event!

**Please note:** This Code of Conduct is subject to change at the discretion of the Based Hack House Thailand organizers.</p>
...
Sponsors can reach us by commenting on this doc or opening a pr on the repo: 

<https://github.com/ivcained/basedhack.house/blob/main/Based%20Hack%20House%20@%20DevCon%207.md>
